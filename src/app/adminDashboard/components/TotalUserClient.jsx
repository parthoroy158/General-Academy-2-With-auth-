...
const TotalUserClient = ({ users, totalUsers, totalPages, currentPage, skip }) => {
    ...
    return (
        <div className="max-w-6xl mx-auto px-6 py-6 dark:text-black">
            <h1 className="text-2xl font-bold text-center text-white bg-gradient-to-r from-blue-500 to-blue-700 py-4 rounded-lg shadow mb-8">
                                ...
                                {users.map((user, index) => (
                                    <tr key={user._id} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="py-3 px-4">
                                            {user.role !== 'admin' ? (
                                                <button
                                                    className={`px-4 py-1 rounded-md text-white text-sm font-medium transition-colors ${loadingId === user._id
